export class LightningBackground {
    constructor(container, options = {}) {
        this.container = container;
        this.hue = options.hue !== undefined ? options.hue : 230;
    ...
    init() {
        ...
        this.uHueLocation = gl.getUniformLocation(this.program, 'uHue');
        this.uXOffsetLocation = gl.getUniformLocation(this.program, 'uXOffset');
        ...
        this.uSizeLocation = gl.getUniformLocation(this.program, 'uSize');
