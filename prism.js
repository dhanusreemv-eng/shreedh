...
export class PrismBackground {
    constructor(container, options = {}) {
        ...
        this.colorFrequency = options.colorFrequency !== undefined ? options.colorFrequency : 1;
        this.hoverStrength = options.hoverStrength !== undefined ? options.hoverStrength : 2;
        this.inertia = options.inertia !== undefined ? options.inertia : 0.05;
        this.bloom = options.bloom !== undefined ? options.bloom : 1;
    ...
    init() {
        ...
        this.render = t => {
            ...
            if (this.animationType === 'hover') {
                ...
                this.yaw = prevYaw + (this.targetYaw - prevYaw) * INERT;
                this.pitch = prevPitch + (this.targetPitch - prevPitch) * INERT;
                this.roll = prevRoll + (0 - prevRoll) * 0.1;
                this.program.uniforms.uRot.value = setMat3FromEuler(this.yaw, this.pitch, this.roll, rotBuf);
                ...
                this.program.uniforms.uRot.value = rotBuf;
                if (TS < 1e-6) continueRAF = false;
            }
