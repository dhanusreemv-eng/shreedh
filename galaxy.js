...
export class GalaxyBackground {
    constructor(container, options = {}) {
        ...
        this.saturation = options.saturation || 0.0;
    ...
    init() {
        ...
        // Apply CSS classes if needed to make the canvas cover the container
        ...
        // must call resize AFTER appending so offsetWidth is correct
        this.resize();
